//
//  JihuomaHistoryViewController.m
//  NB2
//
...
@interface JihuomaHistoryViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JihuomaHistoryViewController
...
- (void)requstHistoryData
{
    ...
    [HttpTool postWithBaseURL:kBaseURL path:@"/api/requestDuihuanjhmjilu" params:paramDict success:^(NSDictionary *dict) {
