...
- (void)setupButtons {
    NSInteger count = 0;
    NSInteger xExtra = 0;
    NSInteger buttonSize = floor(SCREEN_WIDTH / [self.buttonData count]);
...
//        UIImage *hightabButtonBackground = [[UIImage imageNamed:@"hightabButtonBackground"]stretchableImageWithLeftCapWidth:1 topCapHeight:0];
        ...
        //[tabButton setBackgroundImage:[UIImage imageNamed:@"tabButtonBackground"] forState:UIControlStateNormal];
        [tabButton setBackgroundImage:[UIImage imageNamed:@"hightabButtonBackground"] forState:UIControlStateSelected];
