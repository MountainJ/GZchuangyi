...
@interface SubordincsXiaViewController ()
{
    TopView *topView;
...
@end
@implementation SubordincsXiaViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        RecommendViewController *subord=[[RecommendViewController alloc] init];
