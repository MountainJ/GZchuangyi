...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    //datePicker.date =[NSDate alloc] in [[NSDate alloc] i:@"2099-01-01 00:00:00 -0500"];
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        NSDateFormatter *pick=[[NSDateFormatter alloc]init];
        [pick setDateFormat:@"yyyy-MM-dd HH:mm"];
        NSString *picktime=[pick stringFromDate:_datePicker.date];
        _resultString=[NSString stringWithFormat:@"%@",picktime];
    }
