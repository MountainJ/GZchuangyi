...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // Title
        mTitleLabel = [[UILabel alloc] initWithFrame:CGRectInset(self.bounds, 0, 0)];
        mTitleLabel.textAlignment = NSTextAlignmentLeft;
        mTitleLabel.font = [UIFont boldSystemFontOfSize:15];
        mTitleLabel.layer.masksToBounds=YES;
        mTitleLabel.layer.cornerRadius=3;
        mTitleLabel.textColor=[UIColor grayColor];
        mTitleLabel.backgroundColor=[UIColor colorWithRed:221.0/255 green:222.0/255 blue:221.0/255 alpha:1];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    if (mControlIsActive) {
        ...
        if (mSelectionIndex < [mSelectionOptions count]) {
            ...
            [self.delegate dropDownControlView:self didFinishWithSelection:[mSelectionOptions objectAtIndex:0]];
        }
    }
}
...
- (void)activateControl {
    ...
    if (mSelectionCells == nil) {
        ...
        for (int i=0; i < [mSelectionTitles count]; i++) {
            UIImageView *newCell = [[UIImageView alloc]init];
            newCell.backgroundColor=[UIColor colorWithRed:221.0/255 green:222.0/255 blue:221.0/255 alpha:1];
            ...
            UILabel *newLabel = [[UILabel alloc] initWithFrame:CGRectInset(newCell.bounds, 0, 0)];
            ...
            newLabel.backgroundColor=[UIColor colorWithRed:221.0/255 green:222.0/255 blue:221.0/255 alpha:1];
...
- (void)inactivateControl {
    ...
    [self.delegate dropDownControlView:self didFinishWithSelection:[NSNumber numberWithInt:0]];
